 ...
 * DO NOT REMOVE THIS 
 * </b><p>
 * Autogenerated on: Mar 20, 2024, 11:30:58 PM
*/
...
public abstract class Network {
    ...
    public static void uploadImage(@NonNull Uri uri, @Nullable String directory, @Nullable String filename, @Nullable Callback<Uri> response) {
...
*/
    ...
    public static void getUsers(@NonNull Activity cur_act, @NonNull String[] docID, @NonNull Callback<List<User>> response) {
    ...
    public static void getTransactions(@NonNull Activity cur_act, @NonNull String[] docID, @NonNull Callback<List<Transaction>> response) {
    ...
    public static void getTests(@NonNull Activity cur_act, @NonNull String[] docID, @NonNull Callback<List<Test>> response) {
    ...
    public static void getPosts(@NonNull Activity cur_act, @NonNull String[] docID, @NonNull Callback<List<Post>> response) {
