...
*/
    ...
    public static User activeUserToPOJO() {
        return new User(ActiveUser.date_created, ActiveUser.last_name, ActiveUser.middle_name, ActiveUser.first_name, ActiveUser.email, ActiveUser.username, ActiveUser.id, ActiveUser.watch_ids, ActiveUser.transact_ids, ActiveUser.post_ids );
    }
}